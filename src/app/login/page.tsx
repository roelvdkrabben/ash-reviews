    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-lg">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">ASH Reviews</h1>
          <p className="mt-2 text-gray-600">Review Platform</p>
        </div>

        {error === 'unauthorized' && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
            Je email is niet geautoriseerd voor toegang tot dit platform.
          </div>
        )}
        ...
        >
          ...
          <span className="text-gray-700 font-medium">Inloggen met Google</span>
        </button>
